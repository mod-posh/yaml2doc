...
Initializes a new instance of the [YamlLoadException](Parsing.YamlLoadException.md) class with a specified error message and a reference to the inner exception that is the cause of this exception.
...
## Method: #ctor(string)
Initializes a new instance of the [YamlLoadException](Parsing.YamlLoadException.md) class with a specified error message.
