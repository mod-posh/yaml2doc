...
/// </summary>
/// <remarks>
/// Resolution can be forced to a specific dialect by id, or determined by querying each dialect's
/// <see cref="IYamlDialect.CanHandle(YamlDocumentContext)"/> method in order.
/// </remarks>
public sealed class Yaml2DocRegistry
{
    ...
    /// </summary>
    /// <param name="dialects">The collection of dialects to register.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="dialects"/> is null.</exception>
    /// <exception cref="ArgumentException">Thrown when no dialects are provided.</exception>
    ...
    /// </summary>
    /// <param name="context">The loaded YAML document context to evaluate.</param>
    ...
    /// </summary>
    /// <returns>A <see cref="Yaml2DocRegistry"/> preconfigured with the standard dialect.</returns>
