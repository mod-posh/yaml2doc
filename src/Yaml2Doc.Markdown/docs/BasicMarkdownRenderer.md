...
Writes the baseline representation into an existing [StringBuilder](System.Text.StringBuilder.md). Must preserve identical textual output as [RenderBaseline(PipelineDocument)](BasicMarkdownRenderer.md#yaml2doc.markdown.basicmarkdownrenderer.renderbaseline(yaml2doc.core.models.pipelinedocument)).
