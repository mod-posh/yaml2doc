...
A [ParsedArguments](Yaml2Doc.Cli.Yaml2DocCli.ParsedArguments.md) containing parsed values. On error, `ErrorExitCode` and `ErrorMessage` indicate the failure reason and recommended exit code.
