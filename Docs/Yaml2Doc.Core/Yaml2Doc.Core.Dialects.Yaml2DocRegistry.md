...
Creates the default registry for v1 containing only the [StandardYamlDialect](Yaml2Doc.Core.Dialects.StandardYamlDialect.md).

**Returns**

A [Yaml2DocRegistry](Yaml2Doc.Core.Dialects.Yaml2DocRegistry.md) preconfigured with the standard dialect.
