...
Transforms a parsed YAML document into the neutral [PipelineDocument](Yaml2Doc.Core.Models.PipelineDocument.md) model.
...
- [YamlLoadException](Yaml2Doc.Core.Parsing.YamlLoadException.md) — Thrown when a mapping key is not a scalar.
...
A [String](System.String.md) for scalars, [IDictionary<T1,T2>](System.Collections.Generic.IDictionary`2.md) for mappings, [IList<T1>](System.Collections.Generic.IList`1.md) for sequences, or when appropriate.

**Exceptions**

- [YamlLoadException](Yaml2Doc.Core.Parsing.YamlLoadException.md) — Thrown for unsupported node types.
...
Converts the parsed YAML represented by `context` into a neutral [PipelineDocument](Yaml2Doc.Core.Models.PipelineDocument.md) model.
...
- [YamlLoadException](Yaml2Doc.Core.Parsing.YamlLoadException.md) — Thrown when the root node is not a mapping or contains invalid keys.
